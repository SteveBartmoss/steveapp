            ...
            <DivCurso>
                ...
                <DivRead>
                    ...
                    <p className="content-curso">
                        ...
                        poder entender una palabra.
                    </p>

                    <p className="content-curso">
                        Por esta razón las personas pensaron una mejor manera de dar instrucciones a una computadora
                        y está es mediante un lenguaje de programación que sea más fácil de leer para las personas
                        y con esto surgieron los lenguajes de programación, aunque suene ilógico los primeros
                        programas que se crearon estaban escritos por unos y ceros así que los programadores de esa
                        época debian leer muy bien sus códigos para no cometer errores.

                    </p>

                    <p className="content-curso">
                        De manera simple se puede pensar que el proceso de compilar un programa es transformar
                        cada una de nuestras líneas de código a unos y ceros, el procesó verdadero es mucho más
                        complejo que lo que se menciona pero para este curso basta con saber un ejemplo simple ya
                        que la tarea de crear un compilador esta bastante arriba en la escala de aprendizaje ya que
                        esto suele ser un proyecto de una clase de universidad de los últimos grados.
                    </p>
                    ...
                    <p className="content-curso">
                        ...
                        escritura del mismo que también le llaman error lexico.
                    </p>

                    <p className="content-curso">
                        Cuando nuestro programa se termina de compilar y al ejecutarlo no hace lo que esperamos
                        que haga como poner ejemplo no imprime el mensaje correcto o el resultado de una operación
                        es incorrecto entonces estamos frente a un error lógico o un error ala hora de decirle a
                        la computadora lo que tiene que hacer, por esta razón es importante distinguir los dos
                        tipos de errores ya que los dos provienen de diferente parte y de igual manera la forma
                        de resolver cada tipo de error es diferente la una de la otra.
                    </p>
                    ...
                    <p className="content-curso">
                        ...
                        el siguiente el programa sabe que al ver un punto y coma debe leer la siguiente línea de nuestro
                        código, puede que te estés preguntando porque el compilador no puede usar el salto de línea para
                        saber cuándo un renglón termina.
                    </p>

                    <p className="content-curso">
                        Despues de todo usar un salto de linea es lo mas comun pero los humanos lo usamos al escribir y esto 
                        limitaría la forma en que se puede escribir el código pues tendríamos que usar el salto de 
                        línea solamente cuando queremos finalizar una línea de código y no cuando ya se abarcó el espacio 
                        legible en la pantalla. Por lo anterior se decidío usar el punto y cómo carácter final de una línea 
                        de código y así permitir a las personas dar saltos de línea siempre que quieran, logrando que el 
                        código quede de una forma más legible y que no se tenga que desplazar la barra horizontal todo el 
                        tiempo para poder leer una línea bastante larga.
                    </p>
                </DivRead>
