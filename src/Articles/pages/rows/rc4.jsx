        ...
        <>
            <div className="div-about">
                ...
                <div className="back-articles">
                    ...
                    <p className="content-curso">
                        Hoy en dia es comun ver grandes titulos que fueron desarrollados por estudios independientes
                        como stray, papers please, the forest entre muchos otros que demuestran la buena calidad que
                        un creador independiente puede ofrecer y no solo se hacen populadores por ser indies, hace poco
                        probé pineapple on a pizza un juego de un desarrollador llamado Alva majo o al menos así se
                        presenta en Youtube y al probar el juego tuve una buena experiencia aunque fue algo simple ya
                        que en el juego solo se basa en recorrer la isla y no requiere interactuar de forma compleja
                        si no que basta con acercar se a los personajes que bailan o chocar nuestro personaje con
                ...
                <div className="back-articles">
                    <p className="content-curso">
                        ...
                        del rey Arturo con esto la mecánica estaba planteada pero hacía falta algo que la volviera
                        interesante algo que animará a los jugadores a probar lo.
                    </p>

                    <p className="content-curso">
                        Bueno detrás de la simple idea
                        de solo sacar una espada había un modo de multijugador que tendría a los usuarios frustrados por
                        ...
                        botón la espada cae haciendo que pierdas todo el progreso que tenías.
                    </p>
                </div>

                <h1 className="title1">La paz nunca fue una opcion</h1>
                ...
                <div className="back-articles">
                    ...
                    <p className="content-curso">
                        ...
                        pensar en un triple A para pasar un buen rato.
                    </p>
                </div>
