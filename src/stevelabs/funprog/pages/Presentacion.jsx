                ...
                <DivRead>
                    ...
                    <ul>
                        <li className="list-item">
                            <a className="link-tag" href="https://code.visualstudio.com/" rel="noopener noreferrer" target="_blank">Vs code</a>
                        </li>
                        <li className="list-item">
                            <a className="link-tag" href="https://atom-editor.cc/" rel="noopener noreferrer" target="_blank">Atom</a>
                        </li>
                        <li className="list-item">
                            <a className="link-tag" href="https://notepad-plus-plus.org/" rel="noopener noreferrer" target="_blank">NotePad++</a>
                        </li>
                        <li className="list-item">
                            <a className="link-tag" href="https://www.sublimetext.com/" rel="noopener noreferrer" target="_blank">Sublime text</a>
                        </li>
                        <li className="list-item">
                            <a className="link-tag" href="https://www.vim.org/" rel="noopener noreferrer" target="_blank">Vim</a>
                        </li>
                    </ul>
                    <p className="content-curso">
