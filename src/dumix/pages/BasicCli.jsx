                    ...
                    <DivRead>
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                cd: este comando permite al usuario cambiar entre rutas de las
                            ...
                            <p className="content-curso">
                                ls: este comando listara el contenido de la carpeta en la que nos encontramos,
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                touch: este comando permite crear un archivo en la carpeta o ruta actual en la que
                            ...
                            <p className="content-curso">
                                apt update: este comando actualiza las lista de los paquetes disponibles para nuestro
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                apt upgrade: este comando toma la lista actualizada de los paquetes disponibles y los instala,
                            ...
                            <p className="content-curso">
                                dpkg -i: este comando y el parámetro i permiten instalar paquetes .deb que pertenecen a debian,
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                apt install: este comando permite instalar aplicaciones mediante el manejador de parques apt,
                            ...
                            <p className="content-curso">
                                apt install: este comando también permite instalar paquetes .deb con la diferencia de que también
                        ...
                        <BackArticle>
                            ...
                            <p className="content-curso">
                                rm: este comando permite eliminar un archivo pero hay que usarlo con cautela ya que eliminara el archivo sin
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                mv: este comando permite mover una archivo o fichero hacía otra ruta la cual recibe como argumento, para utilizar
                            ...
                            <p className="content-curso">
                                cp: este comando también permite mover un archivo pero tiene la diferencia de que crea una copia del archivo en la
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                pwd: este comando te permite mostrar la ruta actual en la que te encuentras, esto es util para saber en qué nivel te
                                encuentras y poder moverte hacia otro directorio con el comando cd.
                            </p>

                            <p className="content-curso">
                                mkdir: este comando permite crear un directorio con el nombre que le pasemos como argumento, la carpeta será creada
                        ...
                        <BackArticle>
                            <p className="content-curso">
                                man: este comando mostrará información sobre un comando que se pase como parametro, de esta manera podemos aprender
